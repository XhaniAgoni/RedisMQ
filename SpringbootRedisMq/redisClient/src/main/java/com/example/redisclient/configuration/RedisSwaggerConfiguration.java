...
@Configuration
@EnableSwagger2
//http://localhost:6381/swagger-ui.html
...
//配置Swagger的Bean实例
    ...
    public Docket swaggerSpringMvcPlugin() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            //RequestHandlerSelectors指定扫描的包
                .apis(RequestHandlerSelectors.basePackage("com.example.redisclient.controller"))
                .build();
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("http://localhost:6381/help")
                .version("2.0")
                .build();
    }
}
